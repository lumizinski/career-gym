class CareerDashboardsController < ApplicationController
  ...
  def show
    ...
    @weekly_focus = CareerFocus.new(current_user)
    ...
    @top_focus_skill = @weekly_focus.top_skill
    @top_focus_remaining_training_items = @top_focus_skill.present? ? @weekly_focus.pending_training_items_count_for(@top_focus_skill) : 0
